...
- 官方 MiMo Web 端口：`5669`
- fnOS 应用名：`mimocode`
- fpk 包名示例：`mimocode.v0.11.7.fpk`

## 功能概览

`v0.11.7` 修复官方会话同源代理：SSE 实时消息流、动态资源代理和 iframe 会话状态保持。
...
`v0.11.7` 延续工作台辅助页面，并修复官方会话实时刷新和返回状态：
...
```text
同源路径 /mimo-web/（Wrapper 自动代理到本机官方 mimo web）
```
