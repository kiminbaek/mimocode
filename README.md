...
- 官方 MiMo Web 端口：`5669`
- fnOS 应用名：`mimocode`
- fpk 包名示例：`mimocode.v0.11.0.fpk`

## 功能概览

`v0.11.0` 聚焦体验增强：项目概览、模型分组、免费/限免标签、免费模型库、健康检查、安全边界说明、日志诊断、配置备份。
...
`v0.11.0` 新增更像软件工作台的辅助页面：

- 项目概览：扫描当前项目目录、识别常见项目标记和文件类型分布；
- 免费模型库：内置常见免费/限免/试用模型入口，可一键填入 Provider 表单；
- 免费模型库来源说明：该功能仅整理常见 OpenAI 兼容平台的公开入口和模型名预设，没有复制 QwenPaw 或其他第三方项目源码；免费/限免状态以各平台实时政策为准；
